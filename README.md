...
// 3. Create EntityManager with configuration and connection
$entityManager = new EntityManager($config, $connection);

// 4. Query using ObjectQuel language - express complex relationships naturally
...
// Create the EntityManager with configuration and connection
$entityManager = new EntityManager($config, $connection);
```
